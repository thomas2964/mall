...
/** RestTemplate示例Controller Created by macro on 2018/9/17. */
...
public class RestTemplateDemoController {
  ...
  public Object getForEntity(@PathVariable Long id) {
    ...
    ResponseEntity<CommonResult> responseEntity =
        restTemplate.getForEntity(url, CommonResult.class, id);
  ...
  public Object getForEntity2(@PathVariable Long id) {
    ...
    ResponseEntity<CommonResult> responseEntity =
        restTemplate.getForEntity(url, CommonResult.class, params);
    return responseEntity.getBody();
  }
  ...
  public Object getForEntity3(@PathVariable Long id) {
    ...
    UriComponents uriComponents =
        UriComponentsBuilder.fromUriString(url).build().expand(id).encode();
    ResponseEntity<CommonResult> responseEntity =
        restTemplate.getForEntity(uriComponents.toUri(), CommonResult.class);
    return responseEntity.getBody();
  }
  ...
  public Object postForEntity(@RequestBody PmsBrand brand) {
    ...
    ResponseEntity<CommonResult> responseEntity =
        restTemplate.postForEntity(url, brand, CommonResult.class);
    return responseEntity.getBody();
  }
  ...
  public Object postForEntity3(@RequestParam String name) {
    ...
    ResponseEntity<CommonResult> responseEntity =
        restTemplate.postForEntity(url, requestEntity, CommonResult.class);
    return responseEntity.getBody();
  }
}
